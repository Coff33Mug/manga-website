  ...
  return (
      <>
        ...
        <div style={{ display: "flex", marginTop: 10 }}>
          <button className="formatButton" id="denseFormatButton" style={{ borderTopLeftRadius: 5, borderBottomLeftRadius: 5 }}>
          ...
          <button className="formatButton" id="compactFormatButton" style={{ borderTopRightRadius: 5, borderBottomRightRadius: 5 }}>
